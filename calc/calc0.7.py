...
label = Label(root, text='0', font=("Times New Roman", 15, "bold"), bg="#f6f8f9", foreground="#455660", width=20) #поле ввода
label.grid(row=0, column=0, columnspan=3, sticky="nsew")                                                          #его конфурация в сетке
